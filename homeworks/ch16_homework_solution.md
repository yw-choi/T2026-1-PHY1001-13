...
**(d)** 3차 조화파(차수 $n=3$)에서 마디는 $x = j \cdot \dfrac{\lambda_3}{2}$ ($j = 0, 1, 2, 3$)에 위치한다(인덱스 $j$를 조화파 차수 $n$과 분리):

$$x_j = j \times 0.40\;\text{m} \;\Rightarrow\; \boxed{x = 0,\; 0.40,\; 0.80,\; 1.20\;\text{m}}$$
